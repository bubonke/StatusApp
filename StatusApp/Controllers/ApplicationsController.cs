...
namespace StatusApp.Controllers
{
    public class ApplicationsController : Controller
    {
        ...
        {
            ViewBag.StatusID = new SelectList(db.ApplicationStatus, "StatusID", "Pending");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "BuildDataID,BuildingName,BuildingAddress,City,ZipCode,BuildType,NumberFlat,FlatDescription,FlatPrice,image,Image_Name,StatusID")] Application application)
        {
            ...
            ViewBag.StatusID = new SelectList(db.ApplicationStatus, "StatusID", "Pending", application.StatusID);
            return View(application);
        }
